...
-- Clear highlighting in insert mode
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      require('kanagawa').setup {
        ...
        keywordStyle = { italic = false }, -- Disable italics in keywords
      }

      -- Load the colorscheme here.
      -- Kanagawa has three variants: kanagawa-wave (default), kanagawa-dragon, kanagawa-lotus
